...
import org.anti_ad.mc.alias.client.gui.widget.AbstractWidget
...
private class CustomVanillaSliderWidget(val minValue: Double,
    ...
    override fun renderWidget(drawContext: DrawContext,
        ...
        //TODO 1.21.5 IS THIS REALLY NEEDED
        drawContext.drawCenteredString(Vanilla.textRenderer(), message, x + width / 2, y + (height - 8) / 2, l or (MathHelper.ceil(alpha * 255.0f) shl 24))
    }
}
...
private class TextFieldWidget(height: Int): ITextFieldWidget, VanillaWidget<VanillaTextFieldWidget>(CustomTextFieldWidget(Vanilla.textRenderer(), 0, 0, 0, height, "")) {
    ...
    override fun editing(): Boolean = vanilla.isFocused
