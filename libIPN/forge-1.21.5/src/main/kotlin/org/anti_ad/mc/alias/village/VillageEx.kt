...
val ResourceKey<VillagerProfession>.`(professionId)`
    inline get() = this.location().path

val RegistryEntry<VillagerProfession>.`(professionId)`
    get() = this.unwrapKey().get().`(professionId)`
