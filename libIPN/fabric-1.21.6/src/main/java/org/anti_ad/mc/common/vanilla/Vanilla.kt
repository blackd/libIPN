...
import org.anti_ad.mc.alias.util.WorldSavePath
...
object Vanilla {
    ...
    fun ClientPlayerEntity.`(sendCommandMessage)`(msg: String) = this.networkHandler.sendChatCommand(msg.replaceFirst("/", "")) // sendCommand(msg.replaceFirst("/",""))
