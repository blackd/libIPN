...
object VanillaScreenUtil {
    ...
    fun openScreen(screen: IScreenMarker) = Vanilla.mc().openScreen(screen as Screen)
    fun openScreenNullable(screen: IScreenMarker?) = Vanilla.mc().openScreen(screen as Screen)
