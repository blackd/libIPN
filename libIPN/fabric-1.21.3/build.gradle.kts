...
val supported_minecraft_versions = mapOf(MODRINTH to listOf("1.21.3", "24w44a", "24w45a", "24w46a", "1.21.4-pre1"),
                                         CURSEFORGE to listOf("1.21.3", "1.21.4-Snapshot"))
...
val fabric_api_version = "0.109.0+1.21.3"
